            ...
            <form class="article row g-3 w-100 " id="formAddInstrument" method="POST" width="" name="formAddArticle" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="form-group form-control col">
                        ...
                        <input type="text" class="w-100" aria-describedby="" name="lastnameMusician" id="lastnameMusician" onkeypress="verifierCaracteresNom(event); return false;" ></input>
                    </div>
                    <div class="form-group form-control col">
                        <label for="firstnameMusician" class="w-25">Prénom :</label>
                        <input type="text" class="w-100" aria-describedby="" name="firstnameMusician" id="firstnameMusician" onkeypress="verifierCaracteresPrenom(event); return false;" ></input>
                    </div>
            ...
            foreach ($musicians as $item) :
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-outline-danger" onclick="void(0);let a=confirm('Voulez-vous vraiment supprimer le musicien nommé <?=$item->musicianFirstname?>'); if(a){ document.location = '?idMusicianDelete=<?=$item->idMusician?>'; };" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
