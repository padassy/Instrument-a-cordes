...
<body>
    ...
    <div class="container">
      ...
      <button class="btn btn-outline-success" type="submit"><a href="?p=add">Nouvel Article</a></button>
        <button class="btn btn-outline-success" type="submit">New Article</button>
      </div>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-outline-danger" href="?idInstrument=<?=$item->idInstrument?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
